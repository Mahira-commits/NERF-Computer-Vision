...
Original file is located at
    https://colab.research.google.com/drive/1uEpl-BA-4ReuMQfmIwDCwpeAGugO1ooH
...
class StudentModel(nn.Module):
    def __init__(self):
        ...
        # Further reduction in the convolutional layers
        self.conv1 = nn.Conv2d(1, 8, kernel_size=5, padding=2)  # Even fewer filters
        self.pool1 = nn.MaxPool2d(2, 2)  # Pooling to reduce size

        self.conv2 = nn.Conv2d(8, 16, kernel_size=5, padding=2)  # Reduced filter count again
        self.pool2 = nn.MaxPool2d(2, 2)
        self.dropout1 = nn.Dropout2d(0.25)  # Adding dropout to prevent overfitting

        # Reduction in the fully connected layer
        self.fc1 = nn.Linear(16 * 7 * 7, 32)  # Significantly more reduced size
        self.fc2 = nn.Linear(32, 10)  # Final layer for 10 classes
